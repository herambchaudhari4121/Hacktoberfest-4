...
After cloning the repo, create a folder by `Your Name` or `Your Username` , inside the folder `Introduction` -
  - Add a file of `yourname.md`.
  - Edit the file with required details, such as -
    - Name - Wir Coders
  ...
  - Add you Profile Image or Image to the folder(If not then any avatar)*.
